function [scoreKL,scoreCC,scoreNSS,scoreROC]=CompareHeadEyeSalMaps(SalMap2,folderName,imgNum)
...
fileId = fopen([folderName '/HeadEyeSalMaps_bin/SHE' num2str(imgNum) '.bin'], 'rb');
